package com.ztesoft.res.quick.data.syn.schedule;
...
@Configuration
@EnableScheduling
public class DataSynSchedule {
    /**
     * 日志
     */
    private static final Logger log = LoggerFactory.getLogger(DataSynSchedule.class);
