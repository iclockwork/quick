package com.ztesoft.res.quick.data.syn.utils;

import com.ztesoft.res.quick.data.syn.DataSynConstant;
import com.ztesoft.res.quick.data.syn.exceptions.ScheduleException;
import com.ztesoft.res.quick.data.syn.model.entity.ScheduleJob;
import com.ztesoft.res.quick.data.syn.quartz.AsyncJobFactory;
import com.ztesoft.res.quick.data.syn.quartz.SyncJobFactory;
import org.quartz.*;
...
public class ScheduleUtils {
    ...
    public static void createScheduleJob(Scheduler scheduler, String jobName, String jobGroup,
                                         String cronExpression, String sync, Object param) {
        //同步或异步
        Class<? extends Job> jobClass = DataSynConstant.SCHEDULE_JOB_SYNC_YES.equals(sync) ? AsyncJobFactory.class : SyncJobFactory.class;
        ...
        //放入参数，运行时的方法可以获取
        jobDetail.getJobDataMap().put(DataSynConstant.JOB_PARAM_KEY, scheduleJob);
